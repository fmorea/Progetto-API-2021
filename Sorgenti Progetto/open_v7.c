...
unsigned int atoi_func(char *str)
{
    unsigned int val = 0;
...
unsigned int AggiungiGrafo(unsigned int d){
	pq priority[d];
	unsigned int matrice[d*d-2*(d-1)-d];
